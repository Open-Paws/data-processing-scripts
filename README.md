...
**Note:** The datasets processed by these scripts have now been incorporated into a much larger and more comprehensive dataset: [Continued Pre-Training](https://huggingface.co/datasets/open-paws/continued-pretraining).
